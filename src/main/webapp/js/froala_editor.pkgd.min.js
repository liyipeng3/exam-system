...
!
    function(a) {
        ...
        if (a.FE.LinkRegExCommon = "(([" + c + "])|([" + c + "](\\.|-|_|--))){1,}[" + c + "]{1,}", a.FE.LinkRegExEnd = "((:[0-9]{1,5})|)(((\\/|\\?|#)[a-z\\u00a1-\\uffff0-9@?\\|!^=%&amp;/~+#-_{}]*)|())", a.FE.LinkRegExTLD = "((" + a.FE.LinkRegExCommon + ")(\\.(com|net|org|edu|mil|gov|co|biz|info|me|dev)))", a.FE.LinkRegExHTTP = "((ftp|http|https):\\/\\/" + a.FE.LinkRegExCommon + ")", a.FE.LinkRegExAuth = "((ftp|http|https):\\/\\/[\\u0021-\\uffff]{1,}@" + a.FE.LinkRegExCommon + ")", a.FE.LinkRegExWWW = "(www\\." + a.FE.LinkRegExCommon + "\\.[a-z0-9-]{2,24})", a.FE.LinkRegEx = "(" + a.FE.LinkRegExTLD + "|" + a.FE.LinkRegExHTTP + "|" + a.FE.LinkRegExWWW + "|" + a.FE.LinkRegExAuth + ")" + a.FE.LinkRegExEnd, a.FE.LinkProtocols = ["mailto", "tel", "sms", "notes", "data"], a.FE.MAIL_REGEX = /.+@.+\..+/i, a.FE.MODULES.helpers = function(b) {
                ...
                function u() {
                    return null == C && (C = navigator.platform.toUpperCase().indexOf("MAC") >= 0),
                        C
                }
                function v() {
                    function a(a, b) {
                ...
                a.FE.MODULES.selection = function(b) {
                    ...
                    function v() {
                        ...
                        b.opts.keepFormatOnDelete || b.html.fillEmptyBlocks(),
                            ...
                            b.clean.lists(),
                        b.opts.htmlUntouched || b.spaces.normalize();
                ...
                a.FE.MODULES.clean = function(b) {
                    ...
                    function j(c, e) {
                        //参数c -----> 粘贴内容 图片还在 格式化前 —————— 3
                        var f, g = a("<div>" + c + "</div>"),//图片被删除  格式化后 —————— 3
                            h = "";
                        if (g) {
                            var i = b.node.contents(g.get(0)); //g.get(0) ----> 已经经过处理的内容
                    ...
                    if (!b.opts.useClasses && !c) {
                        ...
                        for (e = 0; e < b.doc.styleSheets.length; e++) {
                            ...
                            if (k) for (var n = 0,
                                ...
                                for (f = 0; f < p.length; f++) { ! p[f].getAttribute("fr-original-style") && p[f].getAttribute("style") ? (p[f].setAttribute("fr-original-style", p[f].getAttribute("style")), g.push(p[f])) : p[f].getAttribute("fr-original-style") || (p[f].setAttribute("fr-original-style", ""), g.push(p[f])),
                                h[p[f]] || (h[p[f]] = {});
                ...
                return {
                    ...
                    blockTagsQuery: g,
                    fillEmptyBlocks: m,
                    cleanEmptyTags: h, //清除空标签
                    cleanWhiteTags: L, //清除空标记
                    cleanBlankSpaces: o, //清除空白
                    blocks: n,
                    getDoctype: r,
                    set: A,
                    get: E,
                ...
                a.FE.MODULES.cursorLists = function(b) {
                    ...
                    function f(d) {
                        ...
                        f = i + f + h + a.FE.MARKERS + a.FE.INVISIBLE_SPACE,
                ...
                function f(a) {
                    b.selection.isCollapsed() ? b.helpers.isIOS() ? I = b.snapshot.get() : (b.cursor.backspace(), a.preventDefault(), a.stopPropagation()) : (a.preventDefault(), a.stopPropagation(), b.selection.remove(), b.html.fillEmptyBlocks()),
                        b.placeholder.refresh()
                }
                function g(a) {
                    a.preventDefault(),
                ...
                function p(i) {
                    ...
                    var j = i.which;
                    if (16 === j) return ! 0;
                    if (E = j, j === a.FE.KEYCODE.IME) return H = !0,
                        !0;
                    H = !1;
                    var l = w(j) && !u(i),
                ...
                function t(c) {
                    if (c && 0 === c.which && E && (c.which = E), b.helpers.isIOS() && c && I) if (c.which == a.FE.KEYCODE.ENTER) b.snapshot.restore(I),
                        b.cursor.enter();
                    else if (c.which == a.FE.KEYCODE.BACKSPACE) {
                        var d = b.snapshot.get();
                        b.snapshot.restore(I),
                            b.cursor.backspace(),
                    ...
                    c && c.which == a.FE.KEYCODE.ENTER && b.helpers.isIOS() && s(),
                    c && (c.which == a.FE.KEYCODE.ENTER || c.which == a.FE.KEYCODE.BACKSPACE || c.which >= 37 && c.which <= 40 && !b.browser.msie) && r();
                    var e = function(a) {
                            if (!a) return ! 1;
                            var b = a.innerHTML;
                ...
                function x(c) {
                    var d = c.which;
                    return !! (u(c) || d >= 37 && d <= 40 || !w(d) && d != a.FE.KEYCODE.DELETE && d != a.FE.KEYCODE.BACKSPACE && d != a.FE.KEYCODE.ENTER && d != a.FE.KEYCODE.IME) || (F || (G = b.snapshot.get(), b.undo.canDo() || b.undo.saveStep()), clearTimeout(F), void(F = setTimeout(function() {
                                F = null,
                                    b.undo.saveStep()
                            },
                ...
                function y(a) {
                    var c = a.which;
                    return !! (u(a) || c >= 37 && c <= 40) || void(G && F ? (b.undo.saveStep(G), G = null) : "undefined" != typeof c && 0 !== c || G || F || b.undo.saveStep())
                }
                function z() {
                ...
                a.FE.MODULES.accessibility = function(b) {
                    ...
                    function t() {
                        ...
                        b.events.trigger("toolbar.focusEditor") !== !1 && (b.events.disableBlur(), b.$el.focus(), b.events.focus())
                    }
                    function u(a) {
                        if (b.shared.$f_el) {
                            var d = l();
                ...
                }), a.FE.COPIED_TOKEN = '<span data-copied-from-froala-editor="true"></span>', a.FE.MODULES.paste = function(b) {
                function c(b, c, d) {
                    b && b.clipboardData && b.clipboardData.setData && (b.clipboardData.setData("text/html", c + a.FE.COPIED_TOKEN), b.clipboardData.setData("text/plain", d), b.preventDefault())
                }
                function d(d) {
                    var e = b.html.getSelected();
                    c(d, e, a("<div>").html(e).text()),
                ...
                function e(a) {
                    ...
                    if (r = b.$win.scrollTop(), a && a.clipboardData && a.clipboardData.getData) {
                        ...
                        if (/text\/rtf/.test(c) && (t = a.clipboardData.getData("text/rtf")), /text\/html/.test(c) ? s = a.clipboardData.getData("text/html") : /text\/rtf/.test(c) && b.browser.safari ? s = t: /text\/plain/.test(c) && !b.browser.mozilla && (s = b.html.escapeEntities(a.clipboardData.getData("text/plain")).replace(/\n/g, "<br>")), "" !== s) return j(),
                ...
                function k(b) {
                    return !! b.match(new RegExp(a.FE.COPIED_TOKEN))
                }
                function l(c, d, e) {
                    var f, g = null,
                        j = null;
                    ...
                    if (c.indexOf('id="docs-internal-guid') >= 0 && (c = c.replace(/^[\w\W\s\S]* id="docs-internal-guid[^>]*>([\w\W\s\S]*)<\/b>[\w\W\s\S]*$/g, "$1"), l = !0), !d) {
                        var n = k(c);
                        if (n && (c = c.replace(new RegExp(a.FE.COPIED_TOKEN), ""), c = c.replace(/<meta charset='utf-8'>/g, "").replace(/<!--StartFragment-->/g, "").replace(/<!--EndFragment-->/g, ""), c = c.replace(/^(\r|\n|\t)*/g, "").replace(/(\r|\n|\t)*$/g, "")), !n) {
                            var p = b.opts.htmlAllowedStyleProps;
                            b.opts.htmlAllowedStyleProps = b.opts.pasteAllowedStyleProps,
                                b.opts.htmlAllowComments = !1,
                                c = b.clean.html(c, b.opts.pasteDeniedTags, b.opts.pasteDeniedAttrs),
                    ...
                    if ("string" == typeof q && (c = q), "" !== c) {
                        ...
                        if (b.opts.enter == a.FE.ENTER_BR) for (g = r.querySelectorAll("p, div"), f = g.length - 1; f >= 0; f--) j = g[f],
                        0 === j.attributes.length && (j.outerHTML = j.innerHTML + (j.nextSibling && !b.node.isEmpty(j) ? "<br>": ""));
                        else if (b.opts.enter == a.FE.ENTER_DIV) for (g = r.getElementsByTagName("p"), f = g.length - 1; f >= 0; f--) j = g[f],
                ...
                function c() {
                    return ! b.helpers.isMobile() && void(b.$tooltip && b.$tooltip.removeClass("fr-visible").css("left", "-3000px").css("position", "fixed"))
                }
                function d(c, d) {
                    ...
                    function e(c) {
                        ...
                        if (h.helpers.isIOS() && !h.el.querySelector(".fr-marker") && (h.selection.save(), h.selection.clear(), h.selection.restore()), !f) {
                            ...
                            e.removeClass("test-height"),
                                ...
                                !b.opts.toolbarBottom && e.offset().top + c.outerHeight() + j < a(b.o_doc).height() ? e.css("top", c.position().top + c.outerHeight()) : e.css("bottom", c.parents(".fr-popup, .fr-toolbar").first().height() - c.position().top)
                        }
                        ...
                        e.offset().left < b.$sc.offset().left && "rtl" == b.opts.direction && e.css("margin-left", e.offset().left + e.outerWidth() - b.$sc.offset().left),
                ...
                a.FE.MODULES.popups = function(b) {
                    ...
                    function w() {
                        b.events.on("shared.destroy", v, !0),
                            ...
                            b.events.$on(a(b.o_win), "scroll", o),
                            b.events.on("mousedown",
                                function(a) {
                ...
                a.FE.MODULES.position = function(b) {
                    function c() {
                        ...
                        if (0 === c.top && 0 === c.left && 0 === c.width || 0 === c.height) {
                            ...
                            e.css("display", "none"),
                                ...
                                c.width = 0,
                                c.height = g,
                                c.top = f.top - (b.helpers.isMobile() && !b.helpers.isIOS() ? 0 : b.helpers.scrollTop()),
                                c.right = 1,
                                c.bottom = 1,
                                c.ok = !0,
                            d && b.selection.restore()
                    ...
                    function i(c) {
                        if (c.offsetWidth) {
                            ...
                            var t = h.top && r() && b.helpers.isInViewPort(b.$sc.get(0)),
                                u = h.bottom && s();
                        ...
                        if (!j()) if (b._stickyElements = [], b.helpers.isIOS()) {
                            ...
                            c(),
                                b.events.$on(a(b.o_win), "scroll",
                                    ...
                                    !0)
                        } else "body" !== b.opts.scrollableContainer && b.events.$on(a(b.opts.scrollableContainer), "scroll", l, !0),
                            b.events.$on(a(b.o_win), "scroll", l, !0),
                ...
                function c() {
                    return (b.el.textContent || "").replace(/\u200B/g, "").length
                }
                function d(d) {
            ...
            function k(c) {
                ...
                if (d.length) {
                    ...
                    if (d.removeClass("fr-dragging"), d = b.events.chainTrigger("element.beforeDrop", d), d === !1) return ! 1;
                    var h = d;
            ...
            function j(c) {
                ...
                var d, e = Array.prototype.slice.call(b.el.querySelectorAll("img")),
                    f = [];
                for (d = 0; d < e.length; d++) if (f.push(e[d].getAttribute("src")), a(e[d]).toggleClass("fr-draggable", b.opts.imageMove), "" === e[d].getAttribute("class") && e[d].removeAttribute("class"), "" === e[d].getAttribute("style") && e[d].removeAttribute("style"), e[d].parentNode && e[d].parentNode.parentNode && b.node.hasClass(e[d].parentNode.parentNode, "fr-img-caption")) {
            ...
            function n(c) {
                ...
                if (Fa && Da) {
                    ...
                    ((Da.attr("style") || "").match(/(^height:)|(; *height:)/) || Da.attr("height")) && (Da.css("height", Fa.data("start-height") * Da.width() / Fa.data("start-width")), Da.removeAttr("height"));
                    k(),
            ...
            function U(a, c) {
                if (Da) {
                    ...
                    var e = /^[\d]+((px)|%)*$/g;
                    Da.removeAttr("width").removeAttr("height"),
                        a.match(e) ? Da.css("width", a) : Da.css("width", ""),
                        c.match(e) ? Da.css("height", c) : Da.css("height", ""),
                    Ba() && (Da.parent().removeAttr("width").removeAttr("height"), a.match(e) ? Da.parent().css("width", a) : Da.parent().css("width", ""), c.match(e) ? Da.parent().css("height", c) : Da.parent().css("height", "")),
                ...
                if (a && "IMG" == a.tagName) {
                    if (b.node.hasClass(a, "fr-uploading") || b.node.hasClass(a, "fr-error") ? a.parentNode.removeChild(a) : b.node.hasClass(a, "fr-draggable") && a.classList.remove("fr-draggable"), a.parentNode && a.parentNode.parentNode && b.node.hasClass(a.parentNode.parentNode, "fr-img-caption")) {
                        ...
                        c.removeAttribute("contenteditable"),
                            ...
                            c.classList.remove("fr-draggable");
                        var d = a.nextSibling;
                        d && d.removeAttribute("contenteditable")
                    }
                } else if (a && a.nodeType == Node.ELEMENT_NODE) for (var e = a.querySelectorAll("img.fr-uploading, img.fr-error, img.fr-draggable"), f = 0; f < e.length; f++) aa(e[f])
            }
            function ba() {
        ...
        a.FE.DEFAULTS.imageInsertButtons.push("imageManager"),
            ...
            a.FE.PLUGINS.link = function(b) {
                function c() {
                    ...
                    if (!c && b.$wp) {
                        ...
                        e && (e.contains && e.contains(b.el) || !b.el.contains(e) || b.el == e) && (e = null),
                            f && f == e && "A" == f.tagName ? (b.browser.msie || b.helpers.isMobile()) && (b.selection.info(e).atEnd || b.selection.info(e).atStart) ? null: e: null
                    }
                ...
                function l(a) {
                    ...
                    f = '<div class="fr-link-insert-layer fr-layer fr-active" id="fr-link-insert-layer-' + b.id + '">',
                        f += '<div class="fr-input-line"><input id="fr-link-insert-layer-url-' + b.id + '" name="href" type="text" class="fr-link-attr" placeholder="' + b.language.translate("URL") + '" tabIndex="' + ++g + '"></div>',
            ...
            a.FE.RegisterCommand("linkOpen", {
                ...
                callback: function() {
                    var a = this.link.get();
                    a && (this.o_win.open(a.href, "_blank", "noopener"), this.popups.hide("link.edit"))
                },
                plugin: "link"
            }),
            ...
            a.FE.PLUGINS.table = function(b) {
                ...
                function F(a) {
                    var c = b.$el.find(".fr-selected-cell");
                    "REMOVE" != a ? c.css("background-color", b.helpers.HEXtoRGB(a)) : c.css("background-color", ""),
                        d()
                }
                function G(a) {
                ...
                function J(b) {
                    b = b || null;
                    var c = [];
                    return null == b && ta().length > 0 && (b = ua()),
                    b && b.find("tr").not(b.find("table tr")).each(function(b, d) {
                        var e = a(d),
                            f = 0;
                                ...
                                function(c) {
                                    ...
                                    if (d.length > 0) {
                                        ...
                                        if (c.which == a.FE.KEYCODE.ESC && b.popups.isVisible("table.edit")) return N(),
                                            ...
                                            d = [],
                                            !1;
                                        if (d.length > 1 && (c.which == a.FE.KEYCODE.BACKSPACE || c.which == a.FE.KEYCODE.DELETE)) {
                                            b.undo.saveStep();
        ...
        a.FE.PLUGINS.wordPaste = function(b) {
            // console.log(b);//b 编辑器对象
            function c() {
                b.events.on("paste.wordPaste",
                    function(a) {
                        return C = a,
                            // b.opts.wordPasteModal ? e() : g(!0), //删除检测是否word格式
                            g(!0),
                            !1
                    })
            }
            ...
            function g(a) {
                ...
                0 === C.indexOf("<colgroup>") && (C = "<table>" + C + "</table>"),
                    C = A(C, b.paste.getRtfClipboard());
                var d = b.doc.createElement("DIV");
                d.innerHTML = C,
                    b.html.cleanBlankSpaces(d),
                    C = d.innerHTML,
                    C = b.paste.removeEmptyTags(C),
                    C = C.replace(/\u200b/g, ""),
                    f(),
                    b.paste.clean(C, !0, !0),
            ...
            function i(a, b) {
                // console.log(a); //a是检测到的内容
                // console.log(b); //b是处理内容的方法 1、检测内容格式；2、检测节点类型；3、文本节点和dom的不同处理
            ...
            function l(a, b) {
                ...
                i(c,
                    function(a) {
                        return a.nodeType == Node.ELEMENT_NODE && ("mso-list:Ignore" == a.getAttribute("style") && a.parentNode.removeChild(a), x(a, b)),
                            !0
                    });
                var e = c.innerHTML;
            ...
            function u(a, b, c) {
                for (var d = a.split(c), e = 1; e < d.length; e++) {
                    var f = d[e];
                    if (f = f.split("shplid"), f.length > 1) {
                        f = f[1];
                        for (var g = "",
                                 h = 0; h < f.length && "\\" != f[h] && "{" != f[h] && " " != f[h] && "\r" != f[h] && "\n" != f[h];) g += f[h],
                            h++;
                        var i = f.split("bliptag");
                        if (i && i.length < 2) continue;
                        var j = null;
                        if (i[0].indexOf("pngblip") != -1 ? j = "image/png": i[0].indexOf("jpegblip") != -1 && (j = "image/jpeg"), !j) continue;
                        var k = i[1].split("}");
                        if (k && k.length < 2) continue;
                        var l;
                        if (k.length > 2 && k[0].indexOf("blipuid") != -1) l = k[1].split(" ");
                        else {
                            if (l = k[0].split(" "), l && l.length < 2) continue;
                            l.shift()
                        }
                        var m = l.join("");
                        E[b + g] = {
            ...
            function w(b, c) {
                if (c) {
                    ...
                    if ("IMG" == b.tagName) {
                        ...
                        d = F[b.getAttribute("v:shapes")]
                    } else d = b.parentNode.getAttribute("o:spid");
                    if (b.removeAttribute("height"), d) {
                        E || v(c);
                        var f = E[d.substring(7)];
                        if (f) {
                            var g = t(f.image_hex),
                                h = "data:" + f.image_type + ";base64," + g;
                            "IMG" === b.tagName ? (b.src = h, b.setAttribute("data-fr-image-pasted", !0)) : a(b.parentNode).before('<img data-fr-image-pasted="true" src="' + h + '" style="' + b.parentNode.getAttribute("style") + '">').remove()
                        }
                    }
                }
            }
            function x(a, b) {
                var c = a.tagName,
                    d = c.toLowerCase();
                a.firstElementChild && ("I" == a.firstElementChild.tagName ? n(a.firstElementChild, "em") : "B" == a.firstElementChild.tagName && n(a.firstElementChild, "strong"));
                var e = ["SCRIPT", "APPLET", "EMBED", "NOFRAMES", "NOSCRIPT"];
                if (e.indexOf(c) != -1) return h(a),
                    !1;
                var f = -1,
                    g = ["META", "LINK", "XML", "ST1:", "O:", "W:", "FONT"];
                for (f = 0; f < g.length; f++) if (c.indexOf(g[f]) != -1) return a.innerHTML ? (a.outerHTML = a.innerHTML, h(a), !1) : (h(a), !1);
                if ("TD" != c) {
                    ...
                    if (b && i) {
                        ...
                        for (f = 0; f < j.length; f++) {
                            ...
                            l.push(m),
                                m = d + m,
                                l.push(m);
                            for (var s = 0; s < l.length; s++) b[l[s]] && r(a, b[l[s]])
                        }
                        a.removeAttribute("class")
                    }
                    b && b[d] && r(a, b[d])
                }
                var t = ["P", "H1", "H2", "H3", "H4", "H5", "H6", "PRE"];
                if (t.indexOf(c) != -1) {
                    var u = a.getAttribute("class");
                    if (u && (b && b[c.toLowerCase() + "." + u] && r(a, b[c.toLowerCase() + "." + u]), u.toLowerCase().indexOf("mso") != -1)) {
                        var v = q(u);
                        v = v.replace(/[0-9a-z-_]*mso[0-9a-z-_]*/gi, ""),
                            v ? a.setAttribute("class", v) : a.removeAttribute("class")
                    }
                    var w = a.getAttribute("style"),
                        x = null;
                    if (w) {
                        var y = w.match(/text-align:.+?[; "]{1,1}/gi);
                        y && (x = y[y.length - 1].replace(/(text-align:.+?[; "]{1,1})/gi, "$1"))
                    }
                    p(a)
                }
                if ("TR" == c && o(a, b), "A" == c && !a.attributes.getNamedItem("href") && a.innerHTML && (a.outerHTML = a.innerHTML), "TD" != c && "TH" != c || a.innerHTML || (a.innerHTML = "<br>"), "TABLE" == c && (a.style.width = "100%"), a.getAttribute("lang") && a.removeAttribute("lang"), a.getAttribute("style") && a.getAttribute("style").toLowerCase().indexOf("mso") != -1) {
                    var z = q(a.getAttribute("style"));
                    z = z.replace(/[0-9a-z-_]*mso[0-9a-z-_]*:.+?(;{1,1}|$)/gi, ""),
                        z ? a.setAttribute("style", z) : a.removeAttribute("style")
                }
                return ! 0
            }
            function y(a) {
            ...
            function A(c, d) {
                c = c.replace(/[.\s\S\w\W<>]*(<html[^>]*>[.\s\S\w\W<>]*<\/html>)[.\s\S\w\W<>]*/i, "$1"),
                    z(c);
                var e = new DOMParser,
                    f = e.parseFromString(c, "text/html"),
                    g = f.head, //这个打印出来是大量的@font-face等，如果要改用百度编辑器，或许可借鉴这部分
                    k = f.body, //粘贴到的内容，重要！！！重要！！！重要！！！
                    l = y(g);
                ...
                i(k,
                    ...
                    i(k,
                        function(a) {
                            return a.nodeType != Node.ELEMENT_NODE || "V:IMAGEDATA" != a.tagName && "IMG" != a.tagName || w(a, d),
                                !0
                        }),
                    i(k,
                        function(a) {
                ...
                var n = k.outerHTML,//outerHTML属性获取描述元素（包括其后代）的序列化HTML片段。它也可以设置为用从给定字符串解析的节点替换元素。//要仅获取元素内容的HTML表示形式或替换元素的内容，请使用 innerHTML 属性
                    o = b.opts.htmlAllowedStyleProps;
                return b.opts.htmlAllowedStyleProps = b.opts.wordAllowedStyleProps,
                    n = b.clean.html(n, b.opts.wordDeniedTags, b.opts.wordDeniedAttrs, !1),//处理剪切板内容最终方法 重要！！！
