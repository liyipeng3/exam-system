        ...
        var ve = a("VU/8")(fe, ge, !1, function (e) {
            ...
            methods: T()({}, Object(U.mapMutations)({
                ...
                handleClickSimpleSearch: function () {
                    ...
                    var t = this, a = "", s = "";
                    0 == e ? (a = "考试星权限批量管理能够批量开通/关闭考生的考试星系统权限，考试星权限将会直接影响用户是否能够被用于创建考试星考试、课程、自定义任务，请谨慎操作。", s = "考试星权限批量管理") : 1 == e && (a = "会否权限批量管理能够批量开通/关闭学员的会否系统权限，会否系统权限将会直接影响用户是否能够被用于创建会否练习，请谨慎操作。", s = "会否权限批量管理"), this.$confirm(a, s, {
                        confirmButtonClass: "success",
                        cancelButtonClass: "cancel",
