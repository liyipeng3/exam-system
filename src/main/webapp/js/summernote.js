...
(function (factory) {
    ...
    var dom = (function () {
         ...
         *
         * @param {Node} node
         * @param {Function} [ptional] pred - predicate function
         */
    ...
    */
    ...
    var Fullscreen = function (context) {
        ...
        this.toggle = function () {
            ...
            //解决ios编辑器全屏问题
            //ios中编辑器设置全屏后，会fixed定位，其超出父元素的部分未被隐藏、未被遮挡、可点击可操作但不显示（显示类似透明度为0）
            //因此在全屏操作时将其父元素固定定位，并设置高度
            ...
            if (isiOS) {
                //如果是组合题
                if ($editor.parents(".question-content.comb-mode").length > 0) {
                    needCompat = true;
                }
            }
            ...
            if (this.isFullscreen()) {
                if (needCompat) {
                    $(".question-content.comb-mode").addClass("fullscreen");
                }
                ...
                if (needCompat) {
                    $(".question-content.comb-mode").removeClass("fullscreen");
                }
                $window.off('resize');
                resize({
    ...
    $.summernote = $.extend($.summernote, {
        ...
        options: {
            ...
            icons: {
                ...
                'picture': 'glyphicon glyphicon-camera',
